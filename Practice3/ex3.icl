...
//Start = droptake2 [1, 2, 3, 4, 5, 6, 7, 8, 9] // take 2 , drop (length - 2)
//Start = droptake2 [1, 2]
...
// first create digits function, for transforming digits of number into a an empty list
// secondly, create p function for getting just int input, and transform with digits function
// lastly with pali function, use p, and compare with reverse
